...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new(self):
        ...
        new = User(
            email='eacassecasse@mansto.com',
            password='password',
            first_name='Edmilson',
            last_name='Cassecasse'
        )
        ...
        self.assertIn('eacassecasse@mansto.com', result)
        self.assertIn('password', result)
        self.assertIn('Edmilson', result)
        self.assertIn('Cassecasse', result)
        cursor.close()
        dbc.close()
