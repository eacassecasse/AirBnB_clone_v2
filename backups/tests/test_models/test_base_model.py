...
class TestBasemodel(unittest.TestCase):
    ...
    def test_todict(self):
        ...
        mdl = self.value()
        mdl.firstname = 'Nayara'
        mdl.lastname = 'Cassecasse'
        self.assertIn('firstname', mdl.to_dict())
        self.assertIn('lastname', mdl.to_dict())
        self.assertIn('firstname', self.value(firstname='Nayara').to_dict())
        self.assertIn('lastname', self.value(lastname='Cassecasse').to_dict())
